...
/**
 * Used mainly for obtaining a random phone call type given the probabilities set in the
 * configuration file.
 *
...
public class CallDistribution {
  ...
  public CallDistribution(Configuration config) {
    ...
    for (String callType : callTypes) {
      ...
      weigths.put(callType, params.get("callProb"));
